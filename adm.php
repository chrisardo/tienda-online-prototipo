...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary justify-content-sm-start fixed-top">
        <div class="container-fluid">
                ...
                <ul class="navbar-nav align-self-stretch">
                    ...
                    <li class="nav-item">
                        <div style="margin-left: 1px;"
                            class="navbar-brand order-1 order-justify-content-end dropdown show"
                            id="yui_3_17_2_1_1636218170770_38">
                            <a href="#" tabindex="0" class=" dropdown-toggle" style="color: white;"
                                id="action-menu-toggle-1" aria-label="Menú de usuario" data-toggle="dropdown"
                            ...
                            <div class="dropdown-menu dropdown-menu-right menu align-tr-br" id="action-menu-1-menu"
                                ...
                                data-align="tr-br">
                                <a href="?solicitudempresa=1" class="dropdown-item menu-action" role="menuitem"
                                ...
                                <a href="?empresas=1" class="dropdown-item menu-action select" role="menuitem"
                                    data-title="mymoodle,admin" aria-labelledby="actionmenuaction-1">
                                    <img src="img/venta.png" style="width: 26px; height: 22px;"> <strong>Empresas
                                        aceptadas</strong>
                                </a>
                            </div>
                        </div>
                    ...
                    <li class="nav-item">
                        <div style="margin-left: 1px;"
                            ...
                            <div class="dropdown-menu dropdown-menu-right menu align-tr-br" id="action-menu-1-menu"
                                data-rel="menu-content" aria-labelledby="action-menu-toggle-1" role="menu"
                                data-align="tr-br">
                                <a href="?registrorol=1" class="dropdown-item menu-action" role="menuitem"
                                    data-title="mymoodle,admin" aria-labelledby="actionmenuaction-1">
                                    <img src="img/ordenes.png" style="width: 30px; height: 30px;">
                                    <strong>Registrar rol</strong>
                                </a>
                                <div class="dropdown-divider border-primary" style="background-color:blue;"></div>
                                <a href="?verrol=1" class="dropdown-item menu-action select" role="menuitem"
                                    data-title="mymoodle,admin" aria-labelledby="actionmenuaction-1">
                                    <img src="img/opciones.png" style="width: 26px; height: 22px;"> <strong>Ver
                                        rol</strong>
                                </a>
                            </div>
                        </div>
                    ...
                    <li class="nav-item">
                        <div style="margin-left: 1px;"
                            ...
                            <div class="dropdown-menu dropdown-menu-right menu align-tr-br" id="action-menu-1-menu"
                                data-rel="menu-content" aria-labelledby="action-menu-toggle-1" role="menu"
                                data-align="tr-br">
                                <a href="?regisrepartidor=1" class="dropdown-item menu-action" role="menuitem"
                                    data-title="mymoodle,admin" aria-labelledby="actionmenuaction-1">
                                    <img src="img/ordenes.png" style="width: 30px; height: 30px;">
                                    <strong>Registrar repartidor</strong>
                                </a>
                                <div class="dropdown-divider border-primary" style="background-color:blue;"></div>
                                <a href="?verrepartidor=1" class="dropdown-item menu-action select" role="menuitem"
                                    data-title="mymoodle,admin" aria-labelledby="actionmenuaction-1">
                                    <img src="img/opciones.png" style="width: 26px; height: 22px;"> <strong>Ver
                                        repartidor</strong>
                                </a>
                    ...
                    <li class="nav-item">
                        <div style="margin-left: 1px;"
                            ...
                            <div class="dropdown-menu dropdown-menu-right menu align-tr-br" id="action-menu-1-menu"
                                data-rel="menu-content" aria-labelledby="action-menu-toggle-1" role="menu"
                                data-align="tr-br">
                                <a href="?productoreportados=1" class="dropdown-item menu-action" role="menuitem"
                                    data-title="mymoodle,admin" aria-labelledby="actionmenuaction-1">
                                    <img src="img/reportar.png" style="width: 30px; height: 30px;">
                                    <strong>Productos reportados</strong>
                                </a>
                                <div class="dropdown-divider border-primary" style="background-color:blue;"></div>
                                <a href="?fallasreportadas=1" class="dropdown-item menu-action select" role="menuitem"
                                    data-title="mymoodle,admin" aria-labelledby="actionmenuaction-1">
                                    <img src="img/opciones.png" style="width: 26px; height: 22px;"> <strong>Fallas del
                                        sistema reportados</strong>
                                </a>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        <div style="margin-left: 1px;"
                            ...
                            <div class="dropdown-menu dropdown-menu-right menu align-tr-br" id="action-menu-1-menu"
                                data-rel="menu-content" aria-labelledby="action-menu-toggle-1" role="menu"
                                data-align="tr-br">
                                <a href="?regisciudad=1" class="dropdown-item menu-action" role="menuitem"
                                    data-title="mymoodle,admin" aria-labelledby="actionmenuaction-1">
                                    <img src="img/reportar.png" style="width: 30px; height: 30px;">
                                    <strong>Registrar ciudad</strong>
                                </a>
                                <div class="dropdown-divider border-primary" style="background-color:blue;"></div>
                                <a href="?verciudad=1" class="dropdown-item menu-action select" role="menuitem"
                                    data-title="mymoodle,admin" aria-labelledby="actionmenuaction-1">
                                    <img src="img/opciones.png" style="width: 26px; height: 22px;"> <strong>Ver
                                        ciudades</strong>
                                </a>
                    ...
                    <li class="nav-item">
                        ...
                        <div style="margin-left: 1px;"
                            ...
                            <div class="dropdown-menu dropdown-menu-right menu align-tr-br" id="action-menu-1-menu"
                                data-rel="menu-content" aria-labelledby="action-menu-toggle-1" role="menu"
                                data-align="tr-br">
                                <a href="?regisproducto=1" class="dropdown-item menu-action" role="menuitem"
                                    data-title="mymoodle,admin" aria-labelledby="actionmenuaction-1">
                                    <img src="img/ordenes.png" style="width: 30px; height: 30px;">
                                    <strong>Registrar productos</strong>
                                </a>
                                <div class="dropdown-divider border-primary" style="background-color:blue;"></div>
                                <a href="?verproducto=1" class="dropdown-item menu-action select" role="menuitem"
                                    data-title="mymoodle,admin" aria-labelledby="actionmenuaction-1">
                                    <img src="img/opciones.png" style="width: 26px; height: 22px;"> <strong>Ver
                                        productos</strong>
                                </a>
                    ...
                    <li class="nav-item">
                        ...
                        <div style="margin-left: 1px;"
                            ...
                            <div class="dropdown-menu dropdown-menu-right menu align-tr-br" id="action-menu-1-menu"
                                data-rel="menu-content" aria-labelledby="action-menu-toggle-1" role="menu"
                                data-align="tr-br">
                                <a href="?regiscategoria=1" class="dropdown-item menu-action" role="menuitem"
                                    data-title="mymoodle,admin" aria-labelledby="actionmenuaction-1">
                                    <img src="img/ordenes.png" style="width: 30px; height: 30px;">
                                    <strong>Registrar categorias</strong>
                                </a>
                                <div class="dropdown-divider border-primary" style="background-color:blue;"></div>
                                <a href="?vercategoria=1" class="dropdown-item menu-action select" role="menuitem"
                                    data-title="mymoodle,admin" aria-labelledby="actionmenuaction-1">
                                    <img src="img/opciones.png" style="width: 26px; height: 22px;"> <strong>Ver
                                        categorias</strong>
                                </a>
            ...
            <div style="margin-left: 16px;" class="navbar-brand order-1 order-justify-content-end dropdown show"
                id="yui_3_17_2_1_1636218170770_38">
                <a href="#" tabindex="0" class=" " style="color: white;" id="action-menu-toggle-1"
                ...
                <div class="dropdown-menu dropdown-menu-right menu align-tr-br" id="action-menu-1-menu"
                    ...
                    <a href="admreporteventa.php" class="dropdown-item menu-action select" role="menuitem"
                        data-title="mymoodle,admin" aria-labelledby="actionmenuaction-1">
                        <img src="img/ordenes.png" style="width: 26px; height: 22px;"> <strong>Reporte de productos
                            vendidos</strong>
                    </a>
                    <?php } else { ?>
                    <a href="admreserva.php" class="dropdown-item menu-action select" role="menuitem"
                        data-title="mymoodle,admin" aria-labelledby="actionmenuaction-1">
                        <img src="img/ordenes.png" style="width: 26px; height: 22px;"> <strong>ORDENES CLIENTES</strong>
                    </a>
                    <?php } ?>
                    <div class="dropdown-divider border-primary" style="background-color:blue;"></div>
                    <a href="verperfil.php?a=1" class="dropdown-item menu-action select" role="menuitem"
                        data-title="mymoodle,admin" aria-labelledby="actionmenuaction-1">
                        <img src="img/perfil.png" style="width: 26px; height: 22px;"> <strong>PERFIL</strong>
                    </a>
                    <div class="dropdown-divider border-primary" style="background-color:blue;"></div>
                    <a href="informacion.php?adm=1" class="dropdown-item menu-action" role="menuitem"
                        data-title="mymoodle,admin" aria-labelledby="actionmenuaction-1">
