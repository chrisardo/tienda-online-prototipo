            ...
            foreach ($comentarios as $rowco) {
                ...
                <li class="cmmnt">
                    ...
                    <?php
                        ...
                        if ($contar != '0') {
                            $reply = mysqli_query($mysqli, "SELECT * FROM comentarios WHERE reply = '" . $rowco['id_comentario'] . "'  and idproducto='$idproducto' ORDER BY id_comentario DESC LIMIT 1");
                                ...
                                <li class="cmmnt">
                                    <div style="margin-left:42px;" class="replies">
                                        ...
                                        <div style="display: inline-block; ">
                                            ...
                                            <?php }if (base64_encode(@$empresa2['imagempresa'])) { ?>
                                                ...
                                                <?php if (@$_SESSION['idusu']) { ?>
                                                    <?php if (@$_SESSION['idusu'] == $idcom_use) { ?>
                                                        <a href="vercomentario.php?idproducto=<?php echo $id; ?>&user=<?php if (!empty(sed::decryption(@$user2["nombreusu"]))) {
                                                                                                                                                ...
                                                                                                                                                echo sed::decryption(@$empresa2["nombreempresa"]);
                                                                                                                                            } ?>&comentario=<?php echo $rowco['id_comentario']; ?>" style="">
                                                            Responder
                                                        </a>
                                                    <?php } ?>
