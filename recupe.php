...
<head>
    ...
    <title>Recuperar Contraseña | Killari Postres</title>
...
<body style="background-image: url(img/logokillari.jpg);">
    <nav style="width: 100%; height: 50px;" class="fixed-top bg-primary">
        <div class="">
            <a class="" style="margin-left: 16px;" href="logueo.php">
            ...
            <a class="" style="font-size: 22px; margin-top: 12px; color:white;">
                <img src="img/logokillari.jpg" style="width: 35px; height: 34px;" alt="logo killaripostres">
                    ...
                    <form id="loginform" class="form-horizontal" role="form" method="POST" autocomplete="off">
                        ...
                        <div style="margin-top:10px" class="form-group">
                            <div class="col-sm-12 controls">
                                <center><button id="btn-login" type="submit" name="btn_consultar" value="Consultar" class="btn btn-primary">Consultar mi contraseña</a></center>
                            </div>
                        </div>
