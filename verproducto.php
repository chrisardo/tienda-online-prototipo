...
<body>
        ...
        <div class="container-fluid">
            ...
            <div style="margin-left: 1px;" class="navbar-brand order-1 order-justify-content-end dropdown show"
                ...
                <div class="dropdown-menu dropdown-menu-right menu align-tr-br" id="action-menu-1-menu"
                    ...
                    <a onclick="Copy();" class="dropdown-item menu-action select" role="menuitem"
                    ...
                    ?>
                    " class="dropdown-item menu-action select" role="menuitem" data-title="mymoodle,admin"
                        aria-labelledby="actionmenuaction-1">
                        <img src="img/favorito.png" style="width: 26px; height: 22px;"><strong> Agregar
                            favoritos</strong>
                    </a>
                    <div class="dropdown-divider border-primary" style="background-color:blue;"></div>
                    <a href="
                    ...
                    " class="dropdown-item menu-action select" role="menuitem" data-title="mymoodle,admin"
                        aria-labelledby="actionmenuaction-1">
                        <img src="img/reportar.png" style="width: 26px; height: 22px;"><strong> Reportar este
                            producto</strong>
                    </a>
                </div>
                <script>
    ...
    <form action="" id="form-login" method="post">
        <div style="width: 86%; margin-left: 20px;  margin-top: 22px;">
            <div class="row g-3">
                <div class="col">
                    <input type="hidden" class="form-control" name="idproducto" value="<?php echo $id; ?>"
                        required="required" />
                    <label for="" style="color:blue; margin-left: 8px;"
                        class="formulario__label"><strong>Cantidad:</strong> </label>
                    <input type="number" name="cantidadproduct"
                        style="width: 80%; margin-left: 100px; margin-top:-40px;" class="form-control"
        ...
        <div class="row g-3">
            <div style="width: 70%; display: inline-block;">
                ...
                <input type="submit" name="hacerorden" value="HACER MI ORDEN" style="width:90%; margin-left: 40px;"
                    class="btn btn-success">
            </div>
            <div style="width: 30%; display: inline-block;">
                <input type="submit" style="width:86%; margin-left: 5px;" class="btn btn-primary" name="añadircarrito"
    ...
    <form name="form1" method="post" action="">
        ...
        <div style="width: 100%;">
            <input type="hidden" class="form-control" name="idproducto" value="<?php echo $id; ?>"
                required="required" />
            <textarea name="comentario" style="width: 74%;display:inline-block;  margin-left:22px;" rows="2"
                id="textarea"
                class="form-control"><?php if (isset($_GET['user'])) { ?>@<?php echo $_GET['user']; ?><?php } else { ?> Agrega un comentario acerca del producto...<?php } ?></textarea>
            <input type="submit" <?php if (isset($_GET['comentario'])) { ?>name="reply" <?php } else { ?>name="comentar"
                <?php } ?> class="btn btn-primary" style="display:inline-block; margin-top:-38px;" value="Comentar">
        </div>
    </form>
    <?php
