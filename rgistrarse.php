        ...
        <div class="panel panel-info" style="background-color: rgba(0, 0, 0, 0.575);">
            ...
            <div style="padding:6px;" class="panel-body">
                <form class="formulario column" enctype="multipart/form-data" action="" method="post">
                    ...
                    <div class="row g-3">
                        <div class="col">
                            <label for="" style="height:14x; color: #fff;">Fecha nacimiento:</label>
                            <input style="height:14x;" type="date" class="form-control" name="fechanaci" required="required" placeholder="Ejemplo: ">
                        </div>
                        <div class="col">
