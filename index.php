    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse bg-primary p-3 p-lg-0 mt-5 mt-lg-0 d-flex flex-column flex-lg-row flex-xl-row justify-content-lg-end mobileMenu" id="navbarSupportedContent">
        <ul class="navbar-nav align-self-stretch" style="margin-right: 30px;">
          ...
          <li class="nav-item">
            <a class="nav-link <?php if (!@empty($productos == 1)) { ?>active<?php } ?>" href="?productos=1">
              <img src="img/producto.png" style="width: 26px; height: 22px;"> <strong>PRODUCTOS</strong></a>
          </li>
          <div class="dropdown-divider"></div>
          <li class="nav-item">
            <a class="nav-link <?php if (!@empty($vereservas == 1)) { ?>active<?php } ?>" href="?vereservas=1">
              <img src="img/ordenes.png" style="width: 24px; height: 20px;"><strong> MIS ORDENES</strong></a>
          </li>
        </ul>
      </div>
      ...
      <div style="margin-left: 1px;" class="navbar-brand order-1 order-justify-content-end dropdown show" id="yui_3_17_2_1_1636218170770_38">
        ...
        <div class="dropdown-menu dropdown-menu-right menu align-tr-br" id="action-menu-1-menu" data-rel="menu-content" aria-labelledby="action-menu-toggle-1" role="menu" data-align="tr-br">
          ...
          ?>
            ...
            <a href="logueo.php" class="dropdown-item menu-action select" role="menuitem" data-title="mymoodle,admin" aria-labelledby="actionmenuaction-1">
              <img src="img/login.png" style="width: 26px; height: 22px;"><strong>LOGIN</strong>
            </a>
            <div class="dropdown-divider border-primary" style="background-color:blue;"></div>
            <a href="registrarme.php" class="dropdown-item menu-action" role="menuitem" data-title="profile,moodle" aria-labelledby="actionmenuaction-2">
