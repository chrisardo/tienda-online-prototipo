    ...
    <div style="width: 96%; margin-left: 12px; border:2px solid blue;">
                        ...
                        <tr>
                            <td style="vertical-align: middle;">
                                <form action="carrito.php" method="post" style="width:110px; display: inline-block;">
                                    ...
                                    <input type="image" name="eliminarcarrito" src="img/eliminar.png"
                                        style="width: 50px; height: 60px;" value="Quitar"
                                ...
                                <form id="form2" name="form1" method="post" action="carrito.php">
                                    <div style="display:inline-block;">
                                        ...
                                        <input name="cantidad" type="number" id="cantidad"
                                            style="width:40px; height: 40px;" class="formulario__label text-center"
                                            value="<?php echo $cantipedir; ?>" size="1" maxlength="4" />
                                    </div>
                                    <div style="display:inline-block;">
                                        <input type="image" name="imageField3" src="img/actualizar.gif"
                                            style="width: 40px; height: 40px; display:inline-block;" value=""
                                            class="btn btn-sm btn-primary btn-rounded" />
                                    </div>
                                </form>
                                <?php
                            ...
                            <!--<td style="vertical-align: middle;"><?php //echo $cantipedir; 
                                                                                ?></td>-->
                            <td style="vertical-align: middle;"><?php echo sed::decryption($ro['nombreproducto']); ?>
                            </td>
                            <td style="vertical-align: middle;"><?php echo sed::decryption($row2['nombrecateg']); ?>
                            </td>
        ...
        <div class="container container-web-page ">
            <div class="row justify-content-md-center border-primary"
                ...
                <div class="col-12 col-md-6">
                    <h3 style="color:white;" class="text-center text-uppercase poppins-regular font-weight-bold">
                        <strong>CARRIO DE COMPRAS</strong>
                    </h3>
