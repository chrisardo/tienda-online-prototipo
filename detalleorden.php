...
} elseif ($_SESSION['rolusu'] == "user" || $_SESSION['rolusu'] == "repartidor" || $_SESSION['rolusu'] == "a1") {
...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary justify-content-sm-start fixed-top">
    <div class="container-fluid">
      <?php
      if ($_SESSION['rolusu'] == "repartidor" || $_SESSION['rolusu'] == "a1") {
        ?>
        <a class="" href="admreserva.php">
          <img src="img/atras.png" style="width: 30px; height: 40px;">
        </a>
      <?php } else { ?>
        <a class="" href="index.php?vereservas=1">
          <img src="img/atras.png" style="width: 30px; height: 40px;">
        </a>
      <?php } ?>
  ...
  foreach ($orden as $row2) {
    ...
    <div class="container-fluid p-2">
      <center>
        <p style="color:blue; font-size: 22px;"><strong>DATOS DE ENVÍO</strong></p>
      </center>
      <table class="table">
        <thead>
          <tr>
        ...
        <tbody>
          <div class="container_card">
            <tr>
              <td style="vertical-align: middle;"><?php echo sed::decryption($row2['direccion_orden']); ?></td>
              <td style="vertical-align: middle;"><?php echo sed::decryption($row2['referenciadireccion']); ?></td>
              <td style="vertical-align: middle;"><?php echo $row2['celularu']; ?></td>
              <!--<td style="vertical-align: middle;"><?php //echo $row2['fecha_entrega']; ?></td>
              <td style="vertical-align: middle;"><?php //echo  $nombreempresa; 
                                                    ?></td>-->
              <td style="vertical-align: middle;"><?php echo $row2['hora_entrega']; ?></td>
    ...
    <div class="container-fluid p-2" style="margin-top: -25px;">
      ...
      <table class="table">
        ...
        <?php
          $productospedidosql = "SELECT * FROM pedidoproductos where idpago='$idpago'";
          ...
          foreach ($productos_pedido as $rowp) {
            ...
            $consul_em = ("SELECT * FROM logueo_empresa  WHERE logueo_empresa.id_empresa='$id_empresa'");
            ...
            <div class="container_card">
              <tr>
                <!--<th scope="row" style="vertical-align: middle;"><?php //echo $rows['id_carrito']; 
                                                                        ?></th>-->
                <!--<td>
                  <img src="data:image/jpg;base64,<?php //echo $ima_producto; ?>" style="width: 90px; height: 100px;">
                </td>-->
      ...
      <li style="margin-top: -16px;" class="list-group-item d-flex justify-content-between">
        ...
        <strong style="text-align: left; color: #000000;">S/.
          <?php
            $qcanti = "SELECT SUM(total) preciototal FROM pedidoproductos where idpago='$idpago'";
